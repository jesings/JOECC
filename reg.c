...
struct opinfo op2op[] = {
  ...
  [NE_U] = {"setnz", 2}, //precede this by a 
  [NE_F] = {"setnz", 2}, //then a cmovz
  [SUB_U] = {"sub", 2},
  [SUB_F] = {"vsubs", 3},
  ...
  [F2F] = {"cvtss2sd", 2}, //many choices from cvtsd2ss, etc.
  ...
  [BNZ_3] = {"jnz", 2}, //test
  [BEZ_3] = {"jez", 2}, //test
  [ARG_3] = {"mov", 2}, //decide where/when to put, push too
  [RET_3] = {"ret", 0}, //put it in rax
  [INIT_3] = {"", 0}, //not sure
  [PARAM_3] = {"mov", 2}, //not sure
  [CALL_3] = {"call", 1}, //call then mov
  [PHI] = {"", 0}, //no phi nodes by this point
  [TPHI] = {"", 0},//no tphi nodes by this point
  [DEALOC] = {"sub", 2},
  [ADDR_3] = {"lea", 2}, //most likely nop?
  [ASM] = {"", 0}, //figure it out
};
